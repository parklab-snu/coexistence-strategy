...
A coexistence-theoretic approach recovers the same classification but provides a different interpretation (Figure 2C). For a two-strategy game determined by this payoff matrix, the niche difference and fitness difference are given by the following set of equations (Supplementary Text S2):
\begin{align}
...
Thus, understanding mechanisms that promote the evolution of cooperation has remained a central goal in evolutionary biology \citep{west2007evolutionary}.
