...
Replicator equations provide a foundation for analyzing strategy competition and the stability of strategic equilibria, yet they do not explicitly separate the mechanisms that stabilize competition from those that equalize fitness differences between strategies.
Here, we extend modern coexistence theory from community ecology to develop strategic coexistence theory (SCT), a framework for quantifying strategic niche and fitness differences between competing strategies.
...
Finally, applying SCT to microbial public-goods game shows that nonlinear microbial growth can both stabilize and equalize competition between cooperators and defectors, allowing coexistence.
Together, these results show that SCT provides a complementary framework for comparing evolutionary games and teasing apart the coexistence mechanisms underlying strategy competition.
...
Standard evolutionary game theory and replicator equations provide powerful tools for predicting the outcome of strategy competition, including strategic dominance, coexistence, and bistability \citep{hofbauer1998evolutionary,cressman2014replicator}.
...
\subsection*{S3 Applications to mechanisms for the evolution of cooperation}
...
Since $H$ is a monotonically decreasing function of $k$ for $k > 2$, fitness difference will increase with $k$.
