...
Specifically, we consider the following mechanisms: kin selection, direct reciprocity, indirect reciprocity, network reciprocity, and group selection (Figure 2A).
...
All of these mechanisms can be described by a simple $2\times 2$ payoff matrix (Figure 2A), from which the corresponding niche and fitness differences can be computed using \eref{nd} and \eref{fd}.
...
First, the prisoner's dilemma provides a baseline scenario, where defection is evolutionarily stable (Figure 2A).
From the perspective of SCT, there is complete niche overlap, and therefore defection competitively excludes cooperation (Figure 2B).
Building on this, SCT shows that five mechanisms promote evolutionary stability of cooperation via different dynamical routes  (Figure 2B).
For example, kin selection allows the fitness of cooperation to increase as genetic relatedness $r$ increases (Figure 2B).
...
This example resembles the prisoner's dilemma discussed in the previous example (Figure 2).
