...
Both evolutionary game theory and ecological coexistence theory seek to predict the outcome of competition between entities, be they species or strategies, but two fiels have relied primarily on disparate approaches.
In particular, while replicator equations provide an important foundation for understanding the dynamics of strategy competition and determining the stability of strategic equilibria, we .
Here, we extend modern coexistence theory (MCT) from community ecology and develop strategic coexistence theory (SCT), which 
