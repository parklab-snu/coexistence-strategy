...
To this end, evolutionary game theory (EGT) and replicator dynamics have provided key foundations, allowing us to predict the outcome of strategic competition through payoff inequalities, invasion criteria, and stability analysis \citep{schuster1983replicator,hofbauer1998evolutionary,cressman2003evolutionary,shalizi2009dynamics,cressman2014replicator}.
However, less attention has been given to similarities between replicator dynamics and community ecology until recently \citep{gokhale2025higher,tarnita2025reconciling,allesina2026global}, even though the classic replicator equations and the generalized Lotka-Volterra equation are mathematically equivalent \citep{hofbauer1981occurrence,page2002unifying}.
...
In fact, stable polymorphism of evolutionary strategies, such as coexistence of cooperators and defectors, are observed in microbial and other biological systems \citep{gore2009snowdrift,cordero2012public,kocher2018genetic,pollak2021public,lin2024interspecific}, but coexistence-theoretic perspective has often remained implicit.
...
While EGT allows us to predict whether two strategies can coexist or not, a framework for quantifying coexistence mechanisms between competing strategies remains elusive.

Modern coexistence theory (MCT) from community ecology presents a particularly useful framework for quantifying coexistence mechanisms \citep{chesson2000mechanisms,godoy2014phylogenetic,godoy2014phenology,kraft2015plant,adler2026have}. 
...
To do so, we begin with a classic replicator equation, which allows us to model changes in the frequency of competing strategies based on their payoffs \citep{schuster1983replicator,hofbauer1998evolutionary,cressman2003evolutionary,shalizi2009dynamics,cressman2014replicator}:
\begin{equation}
