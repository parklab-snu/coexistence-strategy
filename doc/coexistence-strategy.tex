...
\section*{Comparisons of cooperation mechanisms}
...
Here, we compare five core mechanisms for the evolution of cooperation using SCT and ask how they differ from the perspective of strategy coexistence.
Specifically, we consider the following mechanisms: kin selection, direct reciprocity, indirect reciprocity, network reciprocity, and group selection \citep{nowak2006five}.
All of these mechanisms can be described by a simple $2\times 2$ payoff matrix, from which the corresponding niche and fitness differences can be computed using \eref{nd} and \eref{fd}.

\begin{figure}[!ht]
\includegraphics[width=\textwidth]{../figure/figure_cooperation.pdf}
\caption{
\textbf{Comparisons of three mechanisms for the evolution of cooperation using SCT.}
?
}
\end{figure}
