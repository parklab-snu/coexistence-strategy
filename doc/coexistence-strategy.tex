...
\end{align}
This shows that environmental stochasticity increases the invasion growth rates, meaning that it is intrinsically stabilizing.
...
In the SH example, there is always an unstable internal equilibrium across all ranges of $k$ we consider (Figure 4C).
